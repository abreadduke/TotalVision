...
public:
    ...
    ASPOSE_CELLS_API void ImportObjectArray(const Vector<Aspose::Cells::Object>& objArray, int32_t firstRow, int32_t firstColumn, bool isVertical, int32_t skip);
    /// <summary>
    ...
    /// </summary>
    /// <param name="row">The row index.</param>
    /// <param name="isOriginal">Whether returns the original row height or 0 for hidden row. </param>
    /// <param name="unitType">Unit type of the returned height value</param>
    /// <returns>Row's height</returns>
    ASPOSE_CELLS_API double GetRowHeight(int32_t row, bool isOriginal, CellsUnitType unitType);
    /// <summary>
    ...
    [[deprecated]] ASPOSE_CELLS_API double GetRowOriginalHeightPoint(int32_t row);
    /// <summary>
    /// Gets the column width.
    /// </summary>
    /// <param name="column">The column index.</param>
    /// <param name="isOriginal">Indicates whether getting original width.</param>
    /// <param name="unitType"></param>
    /// <returns></returns>
    ASPOSE_CELLS_API double GetColumnWidth(int32_t column, bool isOriginal, CellsUnitType unitType);
    /// <summary>
    ...
    [[deprecated]] ASPOSE_CELLS_API double GetColumnOriginalWidthPoint(int32_t column);
    /// <summary>
    /// Hides a column.
    /// </summary>
    /// <param name="column">Column index.</param>
    ...
    /// Aspose apologizes for any inconvenience you may have experienced.</remarks>
    /// @deprecated Use Cells.GetColumnWidth(int ,bool , CellsUnitType ) method, instead.
    [[deprecated]] ASPOSE_CELLS_API int32_t GetColumnWidthPixel(int32_t column, bool original);
    /// <summary>
    ...
    /// Aspose apologizes for any inconvenience you may have experienced.</remarks>
    /// @deprecated Use Cells.GetColumnWidth(int ,bool , CellsUnitType ) method, instead.
    [[deprecated]] ASPOSE_CELLS_API double GetColumnWidthInch(int32_t column);
    /// <summary>
    ...
    ASPOSE_CELLS_API Cell Find(const Aspose::Cells::Object& what, const Cell& previousCell);
    /// <summary>
    /// Finds the cell containing with the input object.
    /// </summary>
    /// <param name="what">The object to search for.
    ...
    /// <returns>Cell object.</returns>
    /// <remarks>Returns null (Nothing) if no cell is found.</remarks>
    ASPOSE_CELLS_API Cell Find(const Aspose::Cells::Object& what, const Cell& previousCell, const FindOptions& findOptions);
    /// <summary>
    ...
    /// </summary>
    /// <returns>Enumerator to enumerate all Cell objects that contain embedded picture</returns>
    /// <remarks>
    /// If there is no picture which is set as "Place in Cell" in this worksheet, null will be returned.
    /// </remarks>
    ASPOSE_CELLS_API Enumerator<Cell> GetCellsWithPlaceInCellPicture();
    /// <summary>
