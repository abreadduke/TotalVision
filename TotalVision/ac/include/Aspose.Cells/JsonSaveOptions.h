...
public:
    ...
    /// </summary>
    ASPOSE_CELLS_API Vector<U16String> GetSchemas();
    /// <summary>
    /// The original json schema of each worksheet.
    /// </summary>
    ASPOSE_CELLS_API void SetSchemas(const Vector<U16String>& value);
    /// <summary>
    ...
    /// </remarks>
    ASPOSE_CELLS_API bool GetToExcelStruct();
    /// <summary>
    /// Indicates whether converting to json struct of the Excel file.
    /// </summary>
    /// <remarks>
    /// Only for converting range to JSON.
    /// </remarks>
    ASPOSE_CELLS_API void SetToExcelStruct(bool value);
