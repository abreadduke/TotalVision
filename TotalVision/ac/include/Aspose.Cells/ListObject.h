...
public:
    ...
    ASPOSE_CELLS_API void PutCellValue(int32_t rowOffset, int32_t columnOffset, const Aspose::Cells::Object& value);
    /// <summary>
    /// Put the value to the cell.
    /// </summary>
    /// <param name="rowOffset">The row offset in the table.</param>
    ...
    /// </param>
    ASPOSE_CELLS_API void PutCellValue(int32_t rowOffset, int32_t columnOffset, const Aspose::Cells::Object& value, bool isTotalsRowLabel);
    /// <summary>
