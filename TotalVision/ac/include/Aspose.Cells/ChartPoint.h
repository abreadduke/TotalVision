...
public:
    ...
    /// </summary>
    ASPOSE_CELLS_API Aspose::Cells::Object Get_YValue();
    /// <summary>
    /// Gets or sets the Y value of the chart point.
    /// </summary>
    ASPOSE_CELLS_API void SetYValue(const Aspose::Cells::Object& value);
    /// <summary>
    ...
    /// </summary>
    ASPOSE_CELLS_API Aspose::Cells::Object GetXValue();
    /// <summary>
    /// Gets or sets the X value of the chart point.
    /// </summary>
    ASPOSE_CELLS_API void SetXValue(const Aspose::Cells::Object& value);
    /// <summary>
    ...
    /// </summary>
    ASPOSE_CELLS_API int32_t GetDoughnutInnerRadius();
    /// <summary>
    /// Gets the inner radius of doughnut slice in units of pixels after calls Chart.Calculate() method.
    /// Applies to Doughnut chart.
    /// </summary>
    /// <remarks>NOTE: This property is now obsolete. Instead,
    ...
    [[deprecated]] ASPOSE_CELLS_API int32_t GetInnerRadiusPx();
    /// <summary>
