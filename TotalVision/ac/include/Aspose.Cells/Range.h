...
public:
    ...
    [[deprecated]] ASPOSE_CELLS_API Vector<Range> UnionRang(const Range& range);
    /// <summary>
    /// Returns the union result of two ranges.
    /// </summary>
    ...
    /// <returns>The union of two ranges.
    /// </returns>
    ASPOSE_CELLS_API UnionRange UnionRanges(const Vector<Range>& ranges);
    /// <summary>
    ...
    /// </summary>
    ASPOSE_CELLS_API void Transpose();
    /// <summary>
    ...
    /// </summary>
    /// <param name="options">The options for converting this range to image</param>
    /// <returns></returns>
    ASPOSE_CELLS_API Vector<uint8_t> ToImage(const ImageOrPrintOptions& options);
    /// <summary>
    /// Convert the range to JSON value.
    /// </summary>
    /// <param name="options">The options of converting </param>
    /// <returns></returns>
    ASPOSE_CELLS_API U16String ToJson(const JsonSaveOptions& options);
    /// <summary>
    /// Convert the range to html .
    /// </summary>
    /// <param name="saveOptions">Options for coverting range to html.</param>
    /// <returns></returns>
    ASPOSE_CELLS_API Vector<uint8_t> ToHtml(const HtmlSaveOptions& saveOptions);
