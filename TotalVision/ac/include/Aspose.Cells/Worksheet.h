...
public:
    ...
    /// </summary>
    /// <returns></returns>
    ASPOSE_CELLS_API AdvancedFilter GetAdvancedFilter();
    /// <summary>
    ...
    ASPOSE_CELLS_API Aspose::Cells::Object CalculateFormula(const U16String& formula);
    /// <summary>
    /// Calculates a formula.
    /// </summary>
    /// <param name="formula">Formula to be calculated.</param>
    /// <returns>Calculated formula result.</returns>
    ASPOSE_CELLS_API Aspose::Cells::Object CalculateFormula(const char16_t* formula);
    /// <summary>
    ...
    /// The returned object may be of possible types of <see cref="Cell.Value"/>, or ReferredArea.</returns>
    ...
    /// </remarks>
    ASPOSE_CELLS_API Aspose::Cells::Object CalculateFormula(const U16String& formula, const CalculationOptions& opts);
    /// <summary>
    /// Calculates a formula expression directly.
    /// </summary>
    /// <param name="formula">Formula to be calculated.</param>
    ...
    /// please use <see cref="CalculateArrayFormula(string, CalculationOptions)"/> instead.
    /// </remarks>
    ASPOSE_CELLS_API Aspose::Cells::Object CalculateFormula(const char16_t* formula, const CalculationOptions& opts);
    /// <summary>
    /// Calculates a formula expression directly.
    /// </summary>
    /// <param name="formula">Formula to be calculated.</param>
    /// <param name="pOpts">Options for parsing formula.</param>
    /// <param name="cOpts">Options for calculating formula.</param>
    /// <param name="baseCellRow">The row index of the base cell.</param>
    /// <param name="baseCellColumn">The column index of the base cell.</param>
    /// <param name="calculationData">The calculation data. It is used for the situation
    ...
    /// for <see cref="AbstractCalculationEngine.Calculate(CalculationData)"/>.</param>
    /// <returns>Calculated result of given formula.
    /// The returned object may be of possible types of <see cref="Cell.Value"/>, or ReferredArea.</returns>
    /// <remarks>The formula will be calculated just like it has been set to the specified base cell.
    ...
    /// </remarks>
    ASPOSE_CELLS_API Aspose::Cells::Object CalculateFormula(const U16String& formula, const FormulaParseOptions& pOpts, const CalculationOptions& cOpts, int32_t baseCellRow, int32_t baseCellColumn, const CalculationData& calculationData);
    /// <summary>
    /// Calculates a formula expression directly.
    /// </summary>
    /// <param name="formula">Formula to be calculated.</param>
    ...
    /// <see cref="CalculateArrayFormula(string, FormulaParseOptions, CalculationOptions, int, int, int, int, CalculationData)"/> instead.
    /// </remarks>
    ASPOSE_CELLS_API Aspose::Cells::Object CalculateFormula(const char16_t* formula, const FormulaParseOptions& pOpts, const CalculationOptions& cOpts, int32_t baseCellRow, int32_t baseCellColumn, const CalculationData& calculationData);
    /// <summary>
