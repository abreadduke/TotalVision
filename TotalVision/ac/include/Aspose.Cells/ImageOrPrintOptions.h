...
public:
    ...
    /// </summary>
    /// <remarks>
    /// <para>The default value is 96.</para>
    /// <para>Setting <see cref="HorizontalResolution"/> and <see cref="VerticalResolution"/>
    /// effects the width and height of the output image in pixels.</para>
    /// </remarks>
    ...
    /// <remarks>
    /// <para>The width and height of the output image in pixels will be only based on
    /// the set desired width and height.</para>
    /// <para>The <see cref="HorizontalResolution"/> and <see cref="VerticalResolution"/>
    /// will not effect the width and height of the output image in this case.</para>
    /// </remarks>
