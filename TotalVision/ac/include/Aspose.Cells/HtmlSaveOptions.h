...
public:
    ...
    /// </summary>
    ASPOSE_CELLS_API bool GetAddGenericFont();
    /// <summary>
    /// Indicates whether to add a generic font to CSS font-family.
    /// The default value is true
    /// </summary>
    ASPOSE_CELLS_API void SetAddGenericFont(bool value);
    /// <summary>
    ...
    /// The default value is true.
    /// </summary>
    ASPOSE_CELLS_API bool IsBorderCollapsed();
    /// <summary>
    /// Indicates whether the table borders are collapsed.
    /// The default value is true.
    /// </summary>
    ASPOSE_CELLS_API void SetIsBorderCollapsed(bool value);
    /// <summary>
    /// Indicates whether the html character entities are replaced with decimal code.
    /// (e.g. "&amp;nbsp;" is replaced with "&amp;#160;").
    /// The default value is false.
    /// </summary>
    ASPOSE_CELLS_API bool GetEncodeEntityAsCode();
    /// <summary>
    /// Indicates whether the html character entities are replaced with decimal code.
    /// (e.g. "&amp;nbsp;" is replaced with "&amp;#160;").
    /// The default value is false.
    /// </summary>
    ASPOSE_CELLS_API void SetEncodeEntityAsCode(bool value);
    /// <summary>
    /// Indicates how export OfficeMath objects to HTML, Default value is Image.
    /// </summary>
    ASPOSE_CELLS_API HtmlOfficeMathOutputType GetOfficeMathOutputMode();
    /// <summary>
    /// Indicates how export OfficeMath objects to HTML, Default value is Image.
    /// </summary>
    ASPOSE_CELLS_API void SetOfficeMathOutputMode(HtmlOfficeMathOutputType value);
    /// <summary>
    ...
    /// The default value is null.
    /// </summary>
    ASPOSE_CELLS_API U16String GetCellNameAttribute();
    /// <summary>
    /// Specifies the attribute that indicates the CellName to be written.
    /// (e.g. If the value is "id", then for cell "A1", the output will be:&lt;td id='A1'&gt;).
    /// The default value is null.
    /// </summary>
    ASPOSE_CELLS_API void SetCellNameAttribute(const U16String& value);
    /// <summary>
    /// Specifies the attribute that indicates the CellName to be written.
    /// (e.g. If the value is "id", then for cell "A1", the output will be:&lt;td id='A1'&gt;).
    /// The default value is null.
    /// </summary>
    ASPOSE_CELLS_API void SetCellNameAttribute(const char16_t* value);
