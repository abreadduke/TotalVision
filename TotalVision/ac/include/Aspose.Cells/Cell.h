...
public:
    ...
    ASPOSE_CELLS_API void PutValue(const Aspose::Cells::Object& objectValue);
    /// <summary>
    ...
    /// </summary>
    /// <remarks>When cell's formatting pattern is combined with conditional formatting patterns,
    ...
    ASPOSE_CELLS_API void SetFormula(const U16String& formula, const Aspose::Cells::Object& value);
    /// <summary>
    /// Set the formula and the value(calculated result) of the formula.
    /// </summary>
    /// <param name="formula">The formula.</param>
    /// <param name="value">The value(calculated result) of the formula.</param>
    ASPOSE_CELLS_API void SetFormula(const char16_t* formula, const Aspose::Cells::Object& value);
    /// <summary>
    ...
    /// <param name="value">The value(calculated result) of the formula.</param>
    ASPOSE_CELLS_API void SetFormula(const U16String& formula, const FormulaParseOptions& options, const Aspose::Cells::Object& value);
    /// <summary>
    /// Set the formula and the value(calculated result) of the formula.
    /// </summary>
    /// <param name="formula">The formula.</param>
    /// <param name="options">Options for parsing the formula.</param>
    /// <param name="value">The value(calculated result) of the formula.</param>
    ASPOSE_CELLS_API void SetFormula(const char16_t* formula, const FormulaParseOptions& options, const Aspose::Cells::Object& value);
    /// <summary>
    ...
    /// <remarks>the returned range may be not same with the actual one that this dynamic array formula spills into.
    /// If there are non-empty cells in the range, the formula will be set for current cell only and marked as "#SPILL!".
    /// But for such kind of situation we still return the whole range that this formula should spill into.</remarks>
    ...
    /// </summary>
    ASPOSE_CELLS_API bool IsCheckBoxStyle();
    /// <summary>
    /// Indicates whether setting this cell as a check box.
    /// </summary>
    ASPOSE_CELLS_API void SetIsCheckBoxStyle(bool value);
    /// <summary>
    /// Gets and sets the embeddedn image in the cell.
    /// </summary>
    ASPOSE_CELLS_API Vector<uint8_t> GetEmbeddedImage();
    /// <summary>
    /// Gets and sets the embeddedn image in the cell.
    /// </summary>
    ASPOSE_CELLS_API void SetEmbeddedImage(const Vector<uint8_t>& value);
    /// <summary>
    /// </summary>
